...
import TextAnimationCatalogMotion from '@/components/pages/home/text-animation-catalog-motion';
...
const pageData = {
  pathname: '/skills/animate-text-motion',
  metadata: {
...
export const metadata: Metadata = getMetadata({
  ...
  noIndex: pageData.metadata.noIndex,
});

export default function AnimateTextMotionSkillPage() {
  return (
