...
import TextAnimationCatalogGsap from '@/components/pages/home/text-animation-catalog-gsap';
...
const pageData = {
  pathname: '/skills/animate-text-gsap',
  metadata: {
...
export default function AnimateTextGsapSkillPage() {
  return (
